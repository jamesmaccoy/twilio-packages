...
export default function SubscribeClientImpl() {
        ...
        <AnimatePresence mode="wait">
          {!isRedirecting ? (
              ...
              <div className="bg-white rounded-3xl overflow-hidden relative">
                <div className="bg-teal-500 p-6 text-white relative overflow-hidden">
                  ...
                  <div className="flex justify-between items-start relative z-10">
                    ...
                    <div className="text-right">
                      <p className="text-teal-100 text-xs font-mono uppercase tracking-widest">Class</p>
                      <p className="font-bold text-lg">{isPro ? 'PRO' : 'STANDARD'}</p>
                    </div>
                  </div>

                  <div className="mt-6">
                    <h1 className="text-3xl font-bold tracking-tight">Simple Plek</h1>
                    <p className="text-teal-100 text-sm mt-1">Global Membership Access</p>
                  </div>
                </div>
                ...
                <div className="p-6 pb-8 space-y-6">
                  <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 flex items-center justify-between group">
                    <div>
                      <p className="text-gray-400 text-xs font-mono uppercase tracking-wider mb-1">Token Balance</p>
                      <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-bold text-gray-900">
                          {typeof tokenBalance === 'number' ? tokenBalance.toLocaleString() : '—'}
                        </span>
                        <span className="text-sm text-gray-500 font-medium">TKN</span>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      <div className="flex items-center gap-2 text-gray-400 mb-1">
                        <Calendar size={14} />
                        <span className="text-xs font-mono uppercase tracking-wider">Valid From</span>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 text-gray-400 mb-1">
                        <Calendar size={14} />
                        <span className="text-xs font-mono uppercase tracking-wider">Valid Until</span>
                      </div>
                ...
                <div className="p-6 bg-gray-50 flex items-center justify-between">
                  <div className="flex flex-col gap-1">
                    <p className="text-xs text-gray-400 font-mono uppercase">Boarding in</p>
                    <div className="flex items-center gap-2">
                      <span className="text-2xl font-bold text-teal-600 tabular-nums">00:0{countdown}</span>
            ...
            >
              ...
              <h2 className="text-xl font-semibold text-gray-900">Taking you to your account...</h2>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
    ...
    <div className="min-h-screen w-full bg-white font-[GeistSans] text-[#020817]">
      ...
      <div className="mx-auto max-w-[1376px] px-4 py-16 sm:px-8 sm:py-24">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          <Badge className="mb-6 bg-slate-100 text-slate-600 border-slate-200">Secure Payments by Yoco</Badge>
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-slate-500">
            Unlock curated spaces, community events, and pro hosting features. Join the garden community today.
          </p>
        ...
        <div className="mx-auto mb-16 max-w-4xl">
          <div className="mb-4 flex items-center justify-between px-2">
            <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Member Exclusive Content</h2>
